    ...
    public class CrudEdit
    {
        ...
        */
        ...
        private bool InsertRow(EditDto edit, JObject inputRow, Db db)
        {
            ...
            */
            ...
            var fids = "";
            var values = "";
            var userId = db.GetUserId();   //get userId from child class
            ...
            */
            ...
            if (edit.Col4 != null && edit.Col4.Length == 4)
            {
                ...
                setCol4 = (fldUser != null && fldDate != null)
                    ? string.Format(",{0}='{1}',{2}='{3}'", fldUser, db.GetUserId(), fldDate, _Date.ToDbStr(_now)) :
                (fldUser != null)
                    ? string.Format(",{0}='{1}'", fldUser, db.GetUserId()) :
                (fldDate != null)
        ...
        */
        ...
        private bool DeleteRowsByKeys(EditDto edit, List<string> keys, Db db = null)
        {
            ...
            var count = db.Update(sql, _sqlArgs);
            //if (count == 0)
            //    goto lab_error;
            if (emptyDb)
                db.Dispose();
